    ...
    <html>
            ...
            <body>
                    ...
                    <div class = "navbar navbar-inverse navbar-static-top">
                            ...
                            <div class = "jumbotron">
                                    <center><img src="./images/nitc-logo.png" width="100px"><h1>Welcome to NITC QuestionBank</h1>
                                    <p>Students Affairs Council</p>
                            </div>
            ...
            <?php
                ...
                while ($list=mysqli_fetch_assoc($result)) {
                    if ($list['DP_ID']=="GN") {
                        echo'
                    <a href="./department.php?DP_ID='.$list['DP_ID'].'" class="list-group-item">
                        <h4 class="list-group-item-heading">'.$list['DP_name'].'</h4>
